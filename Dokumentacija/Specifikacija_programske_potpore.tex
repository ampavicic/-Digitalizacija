	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\begin{packed_item}
					...
					\item  \textbf{Cilj:} Verificirati dokumente
				...
				\noindent \underbar{\textbf{UC3 - Preusmijeravanje pristiglog dokumenata}}
				\begin{packed_item}
					
					\item \textbf{Glavni sudionik:} Revizor
					\item  \textbf{Cilj:} Verificirati dokumente
					\item  \textbf{Sudionici:} Računovođa
					\item  \textbf{Preduvjet:} Rađunovođa je provjerio dokument
					\item  \textbf{Opis osnovnog tijeka:}
					
					\item[] \begin{packed_enum}
						
						\item Revizor preusmijerava provjeren dokument
				...
				\noindent \underbar{\textbf{UC3 - Skeniranje i salnje dokumenta}}
				\begin{packed_item}
					
					\item \textbf{Glavni sudionik:} Revizor
					\item  \textbf{Cilj:} Skenirati i arhivirati dokumnet
					\item  \textbf{Sudionici:} Računovođa
					...
					\item[] \begin{packed_enum}
						...
						\item Revizor je skenirao dokumnet
						\item Aplikcaija određuje kojemu revizoru se šalje dokument
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Spremi dokumente u bazu s jedinstvenim brojem arhiva kojeg je generirala apliakcija
