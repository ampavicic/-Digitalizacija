\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\noindent \underbar{\textbf{UC6 - Verifikacija dokumenata}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC7 - Arhiviranje dokumenata}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC8 - Direktorski potpis}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC9 - Pregled potpisanih dokumenata}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC10 - Pregled podataka o zaposlenicima}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC11 - Otvaranje korisničkog računa}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC14 - Dodavanje komenatara dokumentu}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC15 - Pregled arhiviranih dokumenata}}
				\begin{packed_item}
				...
				\pagebreak\noindent \underbar{\textbf{UC16 - Pregled hijerarhija zaposlenika}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC17 - Pregled novijih registracija}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC18 - Dodjela pozicije zaposleniku}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC19 - Dodati zaposlenika u tablicu zaposlenih}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC20 - Ukloniti zaposlenika iz tablice zaposlenih}}
				\begin{packed_item}
